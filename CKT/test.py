...
if TESTSET_DIR != 'synthetic':
    tf.flags.DEFINE_string("train_data_path", 'data/' + TESTSET_DIR + '/' + TESTSET_DIR + '_train1.csv',
                           "Path to the training dataset")
    tf.flags.DEFINE_string("test_data_path", 'data/' + TESTSET_DIR + '/' + TESTSET_DIR + '_valid1.csv', "Path to the testing dataset")
else:
    tf.flags.DEFINE_string("train_data_path", 'data/synthetic/naive_c5_q50_s4000_v0_train1.csv',
                           "Path to the training dataset")
    tf.flags.DEFINE_string("test_data_path", 'data/synthetic/naive_c5_q50_s4000_v0_valid1.csv',
...
def test():
    ...
    test_students, test_max_num_problems, test_max_skill_num = dh.read_test_data_from_csv_file(FLAGS.test_data_path)
