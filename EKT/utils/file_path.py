...
def init_file_path(opt):
    ...
    if opt.data_source == "assist2009_updated":
        ...
        root_path = os.path.join(os.path.abspath("../"), "dataset", "synthetic", "cross_validation_data")
        csv_files = [
        ...
        root_path = os.path.join(os.path.abspath("../"), "dataset", "assist2017", "cross_validation_data")
        csv_files = [
